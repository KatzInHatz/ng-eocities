...
app.controller('myController', function($scope, $timeout, $sce) {
  var toggle = false;
  ...
  $scope.pixelation = 4;
  $scope.jukebox = {
    src: $sce.trustAsResourceUrl("http://uhmp3.com/user-mp3-to/8_scream-and-shout-william-and-britney-spears.mp3"),
    volume: 1
  };
